...
def test_threshold(clim_oisst, clim_oisst_nosmooth, oisst_ts):
    ...
    nptest.assert_array_almost_equal(
        clim_oisst_nosmooth.thresh1[60:].values, th1[60:].values
    )
    nptest.assert_array_almost_equal(
        clim_oisst_nosmooth.thresh2[60:].values, th2[60:].values
    )
    nptest.assert_array_almost_equal(
        clim_oisst_nosmooth.seas1[60:].values, seas1[60:].values, decimal=4
    )
    nptest.assert_array_almost_equal(
        clim_oisst_nosmooth.seas2[60:].values, seas2[60:].values, decimal=4
    )
    ...
    nptest.assert_array_almost_equal(
        clim_oisst.thresh1[82:].values, th1[82:].values
    )
    nptest.assert_array_almost_equal(
        clim_oisst.thresh2[82:].values, th2[82:].values
    )
    nptest.assert_array_almost_equal(
        clim_oisst.seas1[82:].values, seas1[82:].values, decimal=4
    )
    nptest.assert_array_almost_equal(
        clim_oisst.seas2[82:].values, seas2[82:].values, decimal=4
    )
